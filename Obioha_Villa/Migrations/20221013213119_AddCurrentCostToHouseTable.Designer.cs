...
namespace Obioha_VillaAPI.Migrations
{
    ...
    [Migration("20221013213119_AddCurrentCostToHouseTable")]
    partial class AddCurrentCostToHouseTable
    {
            ...
            modelBuilder.Entity("Obioha_VillaAPI.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_Date = new DateTime(2022, 10, 13, 22, 31, 19, 237, DateTimeKind.Local).AddTicks(427),
                            Current_Cost = 0.0,
                            ...
                            Sitting_Rooms_No = 2,
                            Square_Feet = 75,
                            Updated_Date = new DateTime(2022, 10, 13, 22, 31, 19, 237, DateTimeKind.Local).AddTicks(466)
                        },
                        new
                        {
                            Id = 2,
                            Built_Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1969),
                            Created_Date = new DateTime(2022, 10, 13, 22, 31, 19, 237, DateTimeKind.Local).AddTicks(469),
                            Current_Cost = 0.0,
                            ImageUrl = "Derby.jpg",
                            Name = "Derby_One",
                            No_Of_Bedrooms = 2,
                            ...
                            Sitting_Rooms_No = 2,
                            Square_Feet = 75,
                            Updated_Date = new DateTime(2022, 10, 13, 22, 31, 19, 237, DateTimeKind.Local).AddTicks(471)
                        });
                });
