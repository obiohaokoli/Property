...
namespace Obioha_VillaAPI.Migrations
{
    ...
    [Migration("20221013212509_SeedingDataInTheHouseTable")]
    partial class SeedingDataInTheHouseTable
    {
            ...
            modelBuilder.Entity("Obioha_VillaAPI.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_Date = new DateTime(2022, 10, 13, 22, 25, 9, 396, DateTimeKind.Local).AddTicks(6514),
                            ...
                            Sitting_Rooms_No = 2,
                            Square_Feet = 75,
                            Updated_Date = new DateTime(2022, 10, 13, 22, 25, 9, 396, DateTimeKind.Local).AddTicks(6550)
                        },
                        new
                        {
                            Id = 2,
                            Built_Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1969),
                            Created_Date = new DateTime(2022, 10, 13, 22, 25, 9, 396, DateTimeKind.Local).AddTicks(6554),
                            ImageUrl = "Derby.jpg",
                            Name = "Derby_One",
                            No_Of_Bedrooms = 2,
                            No_Of_Toilets = 1,
                            ...
                            Sitting_Rooms_No = 2,
                            Square_Feet = 75,
                            Updated_Date = new DateTime(2022, 10, 13, 22, 25, 9, 396, DateTimeKind.Local).AddTicks(6556)
                        });
                });
