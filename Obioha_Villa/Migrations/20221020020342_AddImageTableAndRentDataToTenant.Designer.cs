...
namespace Obioha_VillaAPI.Migrations
{
    ...
    [Migration("20221020020342_AddImageTableAndRentDataToTenant")]
    partial class AddImageTableAndRentDataToTenant
    {
            ...
            modelBuilder.Entity("Obioha_VillaAPI.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_Date = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2421),
                            ...
                            Sitting_Rooms_No = 2,
                            Square_Feet = 75,
                            Updated_Date = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2460)
                        },
                        new
                        {
                            Id = 2,
                            Built_Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1969),
                            Created_Date = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2463),
                            ...
                            Sitting_Rooms_No = 2,
                            Square_Feet = 75,
                            Updated_Date = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2464)
                        });
                });
            ...
            modelBuilder.Entity("Obioha_VillaAPI.Models.Tenant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2533),
                            ...
                            UpdatedDate = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2537)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2538),
                            Deposite_Amount = 1200m,
                            First_Name = "Peter",
                            House_Id = 0,
                            Imageurl = "",
                            ...
                            Tenancy_Period = "one year",
                            Tenancy_Start_Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(2013),
                            UpdatedDate = new DateTime(2022, 10, 20, 3, 3, 42, 296, DateTimeKind.Local).AddTicks(2541)
                        });
                });
